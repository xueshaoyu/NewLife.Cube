...
namespace Pig.Repository.Entity
{
    ...
    [DataObject]
    [Description("卖家")]
    [BindIndex("IX_Seller_Name", false, "Name")]
    [BindTable("Seller", Description = "卖家", ConnName = "Pig", DbType = DatabaseType.SqlServer)]
    public partial class Seller : ISeller
    {
        #region 属性
        private Int32 _Id;
        /// <summary>编号</summary>
        ...
        /// <summary>养殖户介绍</summary>
        [DisplayName("养殖户介绍")]
        [Description("养殖户介绍")]
        [DataObjectField(false, false, true, 500)]
        [BindColumn("Introduce", "养殖户介绍", "nvarchar(500)")]
        ...
        /// <summary>购买需求描述</summary>
        [DisplayName("购买需求描述")]
        [Description("购买需求描述")]
        [DataObjectField(false, false, true, 500)]
        [BindColumn("Description", "购买需求描述", "nvarchar(500)")]
