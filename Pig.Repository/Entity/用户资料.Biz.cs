...
namespace Pig.Repository.Entity
{
    ...
    public partial class UserData : Entity<UserData>
    {
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化UserData[用户资料]数据……");
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化UserData[用户资料]数据！");
        //}
        ...
        public static UserData FindById(Int32 id)
        {
            if (id <= 0) return null;
