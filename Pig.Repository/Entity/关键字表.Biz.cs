...
{
    /// <summary>关键字表</summary>
    public partial class Keyword : Entity<Keyword>
    {
        #region 对象操作
        static Keyword()
        {
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化Keyword[关键字表]数据……");
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化Keyword[关键字表]数据！");
        //}
        ...
        public static Keyword FindById(Int32 id)
        {
            if (id <= 0) return null;
        ...
        public static IList<Keyword> FindAllByName(String name)
        {
            // 实体缓存
