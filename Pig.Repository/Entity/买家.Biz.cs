...
{
    /// <summary>买家</summary>
    public partial class Buyer : Entity<Buyer>
    {
        #region 对象操作
        static Buyer()
        {
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化Buyer[买家]数据……");
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化Buyer[买家]数据！");
        //}
        ...
        public static Buyer FindById(Int32 id)
        {
            if (id <= 0) return null;
        ...
        public static IList<Buyer> FindAllByName(String name)
        {
            // 实体缓存
