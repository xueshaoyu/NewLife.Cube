...
namespace Pig.Repository.Entity
{
    ...
    public partial class UserMsg : Entity<UserMsg>
    {
        #region 对象操作
        static UserMsg()
        {
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化UserMsg[用户消息记录]数据……");

        //    var entity = new UserMsg();
        //    entity.Id = 0;
        //    entity.MsgType = 0;
        //    entity.EventId = 0;
        //    entity.Content = "abc";
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化UserMsg[用户消息记录]数据！");
        //}
        ...
        public static UserMsg FindById(Int32 id)
        {
            if (id <= 0) return null;
