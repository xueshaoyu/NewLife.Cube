...
namespace Pig.Repository.Entity
{
    ...
    [DataObject]
    [Description("关键字表")]
    [BindIndex("IX_Keyword_Name", false, "Name")]
    [BindTable("Keyword", Description = "关键字表", ConnName = "Pig", DbType = DatabaseType.SqlServer)]
    public partial class Keyword : IKeyword
    {
        ...
        #region 字段名
        /// <summary>取得关键字表字段信息的快捷方式</summary>
        ...
        /// <summary>取得关键字表字段名称的快捷方式</summary>
