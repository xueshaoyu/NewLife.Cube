...
namespace Pig.Repository.Entity
{
    ...
    public partial class KeyContent : Entity<KeyContent>
    {
        #region 对象操作
        static KeyContent()
        {
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化KeyContent[关键字返回内容]数据……");

        //    var entity = new KeyContent();
        //    entity.Id = 0;
        //    entity.Title = "abc";
        //    entity.Content = "abc";
        //    entity.KeywordId = 0;
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化KeyContent[关键字返回内容]数据！");
        //}
        ...
        [XmlIgnore]
        //[ScriptIgnore]
        public Keyword Keyword { get { return Extends.Get(nameof(Keyword), k => Keyword.FindById(KeywordId)); } }

        /// <summary>关键字</summary>
        [XmlIgnore]
        //[ScriptIgnore]
        [DisplayName("关键字")]
        [Map(__.KeywordId, typeof(Keyword), "Id")]
        public String KeywordName { get { return Keyword?.Name; } }
        #endregion
        ...
        public static KeyContent FindById(Int32 id)
        {
            if (id <= 0) return null;
