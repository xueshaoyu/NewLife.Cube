...
{
    /// <summary>卖家</summary>
    public partial class Seller : Entity<Seller>
    {
        #region 对象操作
        static Seller()
        {
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化Seller[卖家]数据……");
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化Seller[卖家]数据！");
        //}
        ...
        public static Seller FindById(Int32 id)
        {
            if (id <= 0) return null;
        ...
        public static IList<Seller> FindAllByName(String name)
        {
            // 实体缓存
