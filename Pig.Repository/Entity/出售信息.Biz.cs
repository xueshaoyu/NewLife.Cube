...
namespace Pig.Repository.Entity
{
    ...
    public partial class SellInfo : Entity<SellInfo>
    {
        #region 对象操作
        static SellInfo()
        {
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化SellInfo[出售信息]数据……");

        //    var entity = new SellInfo();
        //    entity.Id = 0;
        //    entity.SellerId = 0;
        //    entity.PubTime = "abc";
        //    entity.SellNumber = 0;
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化SellInfo[出售信息]数据！");
        //}
        ...
        [XmlIgnore]
        //[ScriptIgnore]
        public Seller Seller { get { return Extends.Get(nameof(Seller), k => Seller.FindById(SellerId)); } }

        /// <summary>养殖户</summary>
        [XmlIgnore]
        //[ScriptIgnore]
        [DisplayName("养殖户")]
        [Map(__.SellerId, typeof(Seller), "Id")]
        public String SellerName { get { return Seller?.Name; } }
        #endregion
        ...
        public static SellInfo FindById(Int32 id)
        {
            if (id <= 0) return null;
        ...
        public static IList<SellInfo> FindAllByPubTime(String pubtime)
        {
            // 实体缓存
