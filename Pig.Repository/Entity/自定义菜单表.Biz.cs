...
namespace Pig.Repository.Entity
{
    ...
    public partial class PersonalMenu : Entity<PersonalMenu>
    {
        #region 对象操作
        static PersonalMenu()
        {
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化PersonalMenu[自定义菜单表]数据……");

        //    var entity = new PersonalMenu();
        //    entity.Id = 0;
        //    entity.Name = "abc";
        //    entity.Type = 0;
        //    entity.ParentId = 0;
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化PersonalMenu[自定义菜单表]数据！");
        //}
        ...
        public static PersonalMenu FindById(Int32 id)
        {
            if (id <= 0) return null;
