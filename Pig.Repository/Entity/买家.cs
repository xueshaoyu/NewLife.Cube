...
namespace Pig.Repository.Entity
{
    ...
    [DataObject]
    [Description("买家")]
    [BindIndex("IX_Buyer_Name", false, "Name")]
    [BindTable("Buyer", Description = "买家", ConnName = "Pig", DbType = DatabaseType.SqlServer)]
    public partial class Buyer : IBuyer
    {
        #region 属性
        private Int32 _Id;
        /// <summary>编号</summary>
        ...
        /// <summary>屠宰场介绍</summary>
        [DisplayName("屠宰场介绍")]
        [Description("屠宰场介绍")]
        [DataObjectField(false, false, true, 500)]
        [BindColumn("Introduce", "屠宰场介绍", "nvarchar(500)")]
    ...
    /// <summary>买家接口</summary>
    public partial interface IBuyer
    {
        #region 属性
        /// <summary>编号</summary>
        Int32 Id { get; set; }
