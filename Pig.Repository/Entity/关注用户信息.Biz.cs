...
namespace Pig.Repository.Entity
{
    ...
    public partial class User : Entity<User>
    {
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化User[关注用户信息]数据……");
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化User[关注用户信息]数据！");
        //}
        ...
        /// <summary>根据关注者OpenId查找</summary>
        /// <param name="openid">关注者OpenId</param>
        /// <returns>实体列表</returns>
        public static IList<User> FindAllByOpenId(String openid)
        {
            // 实体缓存
            if (Meta.Session.Count < 1000) return Meta.Cache.FindAll(e => e.OpenId == openid);
