...
namespace Pig.Repository.Entity
{
    ...
    public partial class Driver : Entity<Driver>
    {
        #region 对象操作
        static Driver()
        {
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化Driver[司机信息]数据……");
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化Driver[司机信息]数据！");
        //}
        ...
        public static Driver FindById(Int32 id)
        {
            if (id <= 0) return null;
        ...
        public static IList<Driver> FindAllByName(String name)
        {
            // 实体缓存
