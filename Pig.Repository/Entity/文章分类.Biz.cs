...
namespace Pig.Repository.Entity
{
    ...
    public partial class ArtSort : Entity<ArtSort>
    {
        #region 对象操作
        static ArtSort()
        {
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化ArtSort[文章分类]数据……");

        //    var entity = new ArtSort();
        //    entity.Id = 0;
        //    entity.Name = "abc";
        //    entity.ParentId = 0;
        //    entity.IndexLevel = 0;
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化ArtSort[文章分类]数据！");
        //}
        ...
        public static ArtSort FindById(Int32 id)
        {
            if (id <= 0) return null;
        ...
        public static IList<ArtSort> FindAllByName(String name)
        {
            // 实体缓存
        ...
        /// <summary>根据名称、父菜单查找</summary>
        /// <param name="name">名称</param>
        /// <param name="parentid">父菜单</param>
        /// <returns>实体对象</returns>
        public static ArtSort FindByNameAndParentId(String name, Int32 parentid)
        {
            // 实体缓存
