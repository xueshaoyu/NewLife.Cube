...
namespace XCode.Membership
{
    ...
    public partial class User<TEntity> : Entity<TEntity> where TEntity : User<TEntity>, new()
    {
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化TEntity[用户]数据……");
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化TEntity[用户]数据！");
        //}
        ...
        public static IList<TEntity> FindAllByRoleID(Int32 roleid)
        {
            // 实体缓存
