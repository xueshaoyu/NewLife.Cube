...
(function ($, window) {
    ...
    function initWebUpload(item, options) {
        ...
        if (opts.auto) {
            ...
            uploaderStrdiv =
                ...
                '<div class="btns">' +
                '<div id="' + pickerid + '">选择文件</div>' +
                '<div class="webuploadbtn">开始上传</div>' +
                '</div>'
        }
        ...
        var webuploaderoptions = $.extend({
            ...
            // swf文件路径
            swf: applicationPath + '/Content/webupload/Uploader.swf',
            // 文件接收服务端。
            server: '/Home/AddFile',
    ...
    $.fn.powerWebUpload = function (options) {
        ...
        if (typeof WebUploader == 'undefined') {
            var casspath = applicationPath + "/Content/webupload/webuploader.css";
            $("<link>").attr({ rel: "stylesheet", type: "text/css", href: casspath }).appendTo("head");
            var jspath = applicationPath + "/Content/webupload/webuploader.js";
